  ...
  return (
    <main className="mx-auto max-w-editorial px-5 pb-20 pt-28 md:px-10 md:pb-32 md:pt-36">
      ...
      <p className="mt-3 text-sm text-ink-faint">
        Última actualización: pendiente — texto a redactar antes del lanzamiento.
      </p>
      <div className="mt-10 max-w-prose text-base leading-body text-ink">
        <p>
          Este documento se publicará completo antes de aceptar el primer
          usuario. Es obligatorio antes de la apertura.
        </p>
      </div>
    </main>
  );
